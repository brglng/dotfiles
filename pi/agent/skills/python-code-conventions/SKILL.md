...
- Order imports alphabetically in three groups: standard library, third-party packages, then local modules. Do not import inside functions except test-only imports.
